...
const Home = () => {
  ...
  return (
    <div id="home" className={`select-none w-full h-screen px-10 py-10 md:px-40 lg:px-60 ${theme.font} flex md:flex-row flex-col-reverse justify-center md:justify-between items-center`}>
        ...
        <img src={theme.background === "bg-bg-theme-light" ?  ProfileLight : ProfileDark} className=" animate-fade-left animate-delay-500  w-64 md:w-72 lg:w-96"/>
    </div>
  )
}
