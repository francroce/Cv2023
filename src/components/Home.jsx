...
const Home = () => {
  ...
  return (
    <div className={`select-none w-full h-screen px-10 py-10 md:px-40 lg:px-60 ${theme.font} flex md:flex-row flex-col-reverse justify-center md:justify-between items-center`}>
