...
const Home = () => {
  ...
  return (
    <div className={`w-full h-screen px-20 py-10 md:px-60 ${theme.font} flex md:flex-row flex-col-reverse justify-center md:justify-between items-center`}>
        <div className='w-full md:w-3/6 h-full flex flex-col gap-2 md:gap-4  items-center md:items-start justify-center text-center md:text-left'>
            ...
            <div className="flex gap-5 w-auto justify-between items-center">
                <button className={`text-sm md:text-lg hover:opacity-60 w-auto h-auto px-6 py-3 ${theme.button} rounded-md`}>Contactame</button>
                <a 
                 href={Cv}
