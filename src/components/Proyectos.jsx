...
const Proyectos = () => {
  ...
  return (
    <div className={`w-full  h-auto px-8 py-20 md:py-40 md:px-40 lg:px-60 ${theme.font} flex flex-col justify-center md:justify-between gap-20 items-center md:items-start`}>
