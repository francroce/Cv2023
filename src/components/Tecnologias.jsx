...
const {theme} = useContext(ThemeContext)
  ...
  return (
    <div style={theme.background === "bg-bg-theme-light" ? {backgroundImage: `url(${bgGradientLight})`} : {backgroundImage: `url(${bgGradientDark})`}} className={` overflow-hidden bg-fixed bg-cover bg-center w-full md:h-screen h-auto px-8 py-5 md:py-40 md:px-40 lg:px-60 ${theme.font} flex flex-col justify-center md:justify-between gap-12 items-center md:items-start`}>
